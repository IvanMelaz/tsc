...
@WebAppConfiguration
public class MvcRestAnagraficaTest extends WebParallelTest {
  private static Logger logger = LoggerFactory.getLogger(MvcRestAnagraficaTest.class);
  @Autowired
  ...
  public void testGetAnagrafica() throws Exception {
    ...
    MockHttpServletRequestBuilder builder =
        MockMvcRequestBuilders.get("/user/tscService/getAnagrafica");
