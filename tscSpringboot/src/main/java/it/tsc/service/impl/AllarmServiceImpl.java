...
public class AllarmServiceImpl implements AllarmService {
   ...
   * (non-Javadoc)
   *
   * @see it.tsc.service.AllamService#insertAllarme(java.lang.String, java.sql.Timestamp,
   ...
   * (non-Javadoc)
   *
   * @see it.tsc.service.AllamService#insertAllarmeTel(java.lang.String, java.lang.String,
