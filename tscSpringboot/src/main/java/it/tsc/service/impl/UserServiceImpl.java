...
public class UserServiceImpl implements UserService {
  ...
  public boolean isAdmin(PortalUser user) {
    if (getPortalUser(user.getUsername()) == null) {
      ...
      return getPortalUser(user.getUsername()).getRoles().contains(Role.ROLE_ADMIN.toString());
    } else {
      return false;
    }
  ...
  public boolean isSuperAdmin(PortalUser user) {
    if (getPortalUser(user.getUsername()) != null
      ...
      return getPortalUser(user.getUsername()).getRoles().contains(Role.ROLE_SADMIN.toString());
    } else {
      return false;
    }
