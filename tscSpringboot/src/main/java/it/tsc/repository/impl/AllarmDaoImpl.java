...
public class AllarmDaoImpl extends BaseDao implements AllarmDao {
   ...
   * (non-Javadoc)
   *
   * @see it.tsc.dao.AllarmDao#insertAllarme(java.lang.String, java.sql.Timestamp, java.lang.String,
   * java.lang.String, java.lang.String)
   */
  @Override
  public void insertAllarme(String ab_codi, Instant data_arrivo, String evento, String id_allarme,
      String user) {
    EntityTransaction tx = getEntityTransaction();
    try {
      tx.begin();
      StoredProcedureQuery query =
          getEntityManager().createNamedStoredProcedureQuery(Allarmi.SP_INSERT_ALLARM);
  ...
  public String jsonGetAllarms() {
    EntityManager entityManager = getEntityManager();
    TypedQuery<Allarmi> query =
        entityManager.createNamedQuery(Allarmi.SELECT_ALL_ALLARMS, Allarmi.class);
