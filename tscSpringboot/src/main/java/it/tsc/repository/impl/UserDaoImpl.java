...
public class UserDaoImpl extends BaseDao implements UserDao {
  ...
  public String jsonGetUser(String username) {
    ...
    TypedQuery<User> query = entityManager.createNamedQuery(User.SELECT_BY_USERNAME, User.class);
  ...
  public PortalUser getUser(String username, String email) {
    ...
    TypedQuery<User> query =
        entityManager.createNamedQuery(User.SELECT_BY_USERNAME_EMAIL, User.class);
    query.setParameter("username", username);
  ...
  public List<PortalUser> getAllUsers() {
    ...
    EntityManager entityManager = getEntityManager();
    TypedQuery<User> query = entityManager.createNamedQuery(User.SELECT_ALL_USERS, User.class);
    List<User> list = query.getResultList();
    // entityManager.close();
  ...
  public boolean addUser(String username, String password, String email, Role role,
    ...
    User user = new User(new UserKey(username, role), bcryptEncoder.encode(password).trim(), email,
        mfaEnabled);
    EntityManager entityManager = getEntityManager();
  ...
  public void updateMfaUserKey(String username, String keyId, String base32Secret, String role) {
    ...
    tx.begin();
    try {
      Query query = entityManager.createNamedQuery(User.UPDATE_BY_USERNAME_ROLE);
      query.setParameter("username", username);
   ...
   *
   * @see it.tsc.dao.UserDao#updateUser(java.lang.String,java.lang.String,java. lang.
  ...
  public void updateUser(String username, String password, String email, Role role,
    ...
    tx.begin();
    try {
      Query query = entityManager.createNamedQuery(User.UPDATE_USER, User.class);
      query.setParameter("username", username);
