 ...
 */
public class CassandraBaseDomainTest extends DSClientFactory {
	public final String PU = "mysql_pu";
	private EntityManager em = null;
	protected static final Logger logger = LoggerFactory.getLogger(CassandraBaseDomainTest.class);
	private Map<String, Object> propertyMap = new HashMap<String, Object>();

	public CassandraBaseDomainTest() {
		super();
	}
